...
public class StatePanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        requestButton.setText(java.util.ResourceBundle.getBundle("reader/reader").getString("requests"));
        ...
        reserveButton.setText(java.util.ResourceBundle.getBundle("reader/reader").getString("reservations"));
        ...
        borrowButton.setText(java.util.ResourceBundle.getBundle("reader/reader").getString("borrows"));
    ...
    private void requestButtonAccept(){
        try{
            Collection<BookCopy> books = sData.getLibrary().getRequestedBooks();
    ...
    private void reserveButtonAccept(){
        try{
            Collection<ReservationDetails> books = sData.getLibrary().getReservedBooks();
    ...
    private void borrowButtonAccept(){
        try{
            Collection<BookCopy> books = sData.getLibrary().getBorrowedBooks();
