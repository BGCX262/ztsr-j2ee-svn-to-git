...
public class ResultPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        titleLabel.setText(java.util.ResourceBundle.getBundle("reader/reader").getString("results"));
        ...
        titlePanelLayout.setHorizontalGroup(
            ...
            .add(titlePanelLayout.createSequentialGroup()
                .addContainerGap()
                .add(titleLabel, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 107, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
        ...
        detailsButton.setText(java.util.ResourceBundle.getBundle("reader/reader").getString("copies"));
        ...
        resultsTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
				...
				ResourceBundle.getBundle("reader/reader").getString("publish_year"),
				ResourceBundle.getBundle("reader/reader").getString("available_copies")
            }
        ) {
    ...
    private void detailsButtonAccept(){
        ...
        if (rowSelected == -1){
            JOptionPane.showMessageDialog(this, 
                    ResourceBundle.getBundle("reader/reader").getString("choose_position_to_watch_copies"),
                    ResourceBundle.getBundle("reader/reader").getString("warning"),
                    JOptionPane.WARNING_MESSAGE);
        }else{
            try{
                Collection<ReservationDetails> books = sData.getSession().getBookCopies(
                booksDetails.get(Integer.valueOf(rowSelected)).getBookId());
                this.setVisible(false);
