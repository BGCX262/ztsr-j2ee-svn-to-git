...
public class FindPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        descriptionLabel.setText(java.util.ResourceBundle.getBundle("reader/reader").getString("data_about_wanted_book"));

        autorLabel.setFont(new java.awt.Font("Tahoma", 1, 12));
        autorLabel.setText(java.util.ResourceBundle.getBundle("reader/reader").getString("author_"));

        titleLabel.setFont(new java.awt.Font("Tahoma", 1, 12));
        titleLabel.setText(java.util.ResourceBundle.getBundle("reader/reader").getString("title_"));

        publisherLabel.setFont(new java.awt.Font("Tahoma", 1, 12));
        publisherLabel.setText(java.util.ResourceBundle.getBundle("reader/reader").getString("publisher_"));

        yearLabel.setFont(new java.awt.Font("Tahoma", 1, 12));
        yearLabel.setText(java.util.ResourceBundle.getBundle("reader/reader").getString("publish_year_"));
        ...
        exclusiveCheckBox.setText(java.util.ResourceBundle.getBundle("reader/reader").getString("only_with_available_copies"));
        ...
        findButton.setText(java.util.ResourceBundle.getBundle("reader/reader").getString("find"));
    ...
    private void  findButtonAccept(){
        ...
        if ((!this.yearField.getText().equalsIgnoreCase(""))&&(this.yearField.getText()!=null)){
            try{
                ...
                JOptionPane.showMessageDialog(this,
                        ResourceBundle.getBundle("reader/reader").getString("wrong_year_format"), 
        ...
        s.setOnlyAvailableCopies( this.exclusiveCheckBox.isSelected());
        
        try{
            Collection<Book> books = sData.getSession().findBooks(s);
            this.setVisible(false);
