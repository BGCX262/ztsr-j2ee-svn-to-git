...
public class MenuPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        stateButton.setText(java.util.ResourceBundle.getBundle("reader/reader").getString("account_state"));
        ...
        findButton.setText(java.util.ResourceBundle.getBundle("reader/reader").getString("search"));
        ...
        logOutButton.setText(java.util.ResourceBundle.getBundle("reader/reader").getString("log_out"));
